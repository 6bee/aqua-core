...
{
    private static T Roundtrip<T>(T graph, ReferenceHandler referenceHandler)
    {
        var options = new ProtoOptions { ReferenceHandler = referenceHandler };
        var data = AquaProtobufSerializer.Serialize(graph, options);
        return AquaProtobufSerializer.Deserialize<T>(data, options);
    }
    ...
    public void Preserve_should_restore_shared_reference_identity()
    {
        ...
        var result = Roundtrip((DynamicObject)root, ReferenceHandler.Preserve);
    ...
    public void Unspecified_should_not_restore_shared_reference_identity()
    {
        ...
        var result = Roundtrip((DynamicObject)root, ReferenceHandler.Unspecified);
    ...
    public void IgnoreCycles_should_not_restore_shared_reference_identity()
    {
        ...
        var result = Roundtrip((DynamicObject)root, ReferenceHandler.IgnoreCycles);
    ...
    public void Preserve_should_restore_circular_reference()
    {
        ...
        var result = Roundtrip((DynamicObject)obj0, ReferenceHandler.Preserve);
    ...
    public void IgnoreCycles_should_break_circular_reference()
    {
        ...
        var result = Roundtrip((DynamicObject)obj0, ReferenceHandler.IgnoreCycles);
    ...
    public void Unspecified_throws_on_circular_reference()
    {
        ...
        Should.Throw<InvalidOperationException>(() => Roundtrip((DynamicObject)obj0, ReferenceHandler.Unspecified))
