...
public class When_using_codec
{
    ...
    public static IEnumerable<object[]> TestValues
    {
        get
        {
            ...
            yield return [DateTime.MaxValue.ToMicrosecondPrecision().ToUniversalTime()];
            ...
            yield return [TimeSpan.MaxValue.ToMicrosecondPrecision()];
            yield return [TimeSpan.MinValue.ToMicrosecondPrecision()];
