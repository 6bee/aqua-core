...
public abstract class When_serializing_dynamicobject_for_collections_of_notnullable(Func<DynamicObject, DynamicObject> serialize)
{
    ...
    public class With_messagepack_serializer() : When_serializing_dynamicobject_for_collections_of_notnullable(MessagePackSerializationHelper.Clone);

    public class With_protobuf_serializer() : When_serializing_dynamicobject_for_collections_of_notnullable(ProtobufSerializationHelper.Clone);
