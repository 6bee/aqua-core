...
public abstract class When_using_typeinfo_with_circular_reference_with_anonymous_type
{
    ...
    public class With_messagepack_serializer() : When_using_typeinfo_with_circular_reference_with_anonymous_type(MessagePackSerializationHelper.Clone);

    public class With_protobuf_serializer() : When_using_typeinfo_with_circular_reference_with_anonymous_type(ProtobufSerializationHelper.Clone);
