...
public static class TestHelper
{
    ...
    public static void SequenceShouldBeEqual(this IEnumerable result, IEnumerable expected)
        => result.Cast<object>().SequenceShouldBeEqual(expected.Cast<object>());
    ...
    private sealed class SimpleEqualityComparer<T>(Func<T, T, bool> compare) : IEqualityComparer<T>
    {
        private readonly Func<T, T, bool> _compare = compare ?? throw new ArgumentNullException(nameof(compare));
