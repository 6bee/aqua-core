...
/// <summary>
/// MessagePack formatter for <see cref="MethodInfo"/>.
/// </summary>
/// <remarks>
/// Encodes as a fixed-length array matching the declared <c>[DataMember]</c> order:
/// <c>[Name, IsStatic, DeclaringType, GenericArgumentTypes, ParameterTypes, ReturnType]</c>.
/// </remarks>
public sealed class MethodInfoFormatter : IMessagePackFormatter<MethodInfo?>
{
    /// <summary>
    /// Gets the singleton instance of the <see cref="MethodInfoFormatter"/>.
    /// </summary>
    ...
    /// <inheritdoc/>
    public void Serialize(ref MessagePackWriter writer, MethodInfo? value, MessagePackSerializerOptions options)
    {
        writer.SerializeReferenceValue(FieldCount, value, options, SerializeMembers);

        static void SerializeMembers(ref MessagePackWriter writer, MethodInfo value, MessagePackSerializerOptions options)
        {
            ...
            TypeInfoFormatter.Instance.Serialize(ref writer, value.ReturnType, options);
    ...
    /// <inheritdoc/>
    public MethodInfo? Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
    {
        return reader.DeserializeReferenceValue<MethodInfo>(options, DeserializeMembers);

        static void DeserializeMembers(ref MessagePackReader reader, uint fieldCount, MethodInfo value, MessagePackSerializerOptions options)
        {
            ...
            value.ReturnType = fieldCount > 5 ? TypeInfoFormatter.Instance.Deserialize(ref reader, options) : null;
